---
layout: base.njk
title: Area Ham-Fests
permalink: /hamfests/
---

## Area Ham-Fests & Conventions

Ham-fests are gatherings where amateur radio operators buy, sell, and trade equipment, attend seminars, and connect with fellow hams. Below is a listing of upcoming ham-fests in our area.

### 2026 Ham-Fest Calendar

#### Winter Valley Ham-Fest
**Date**: February 15, 2026
**Time**: 8:00 AM - 2:00 PM
**Location**: Valley Fairgrounds, 456 Fair Way
**Admission**: $5 (Free for kids under 12)
**Features**:
- Indoor flea market with 100+ tables
- VE testing (Walk-ins welcome)
- Door prizes
- Food vendors
**Contact**: winterfest@example.com

---

#### Spring Technical Conference
**Date**: April 5-6, 2026
**Time**: Friday 2:00 PM - Sunday 12:00 PM
**Location**: Downtown Convention Center
**Admission**: $15 advance, $20 at door
**Features**:
- Technical seminars and workshops
- Manufacturer exhibits
- Contest station demonstrations
- Banquet dinner Saturday evening
- VE testing both days
**Contact**: springtech@example.com
**Website**: www.springtechconf.example
...
**Location**: County Fairgrounds, Building B
**Admission**: $3 (Advance), $5 (At door)
**Features**:
...
- Grand prize drawing
**Contact**: memorialham@example.com
...
- Bring cash (many sellers don't take cards)
- Bring a bag or cart for purchases
- Test equipment if possible before buying
- Network and make new friends
- Attend seminars to learn something new
- Don't forget your business cards or QSL cards

### Table Rental Information

Most ham-fests offer table rentals for sellers. Contact the individual event organizers for pricing and availability.
